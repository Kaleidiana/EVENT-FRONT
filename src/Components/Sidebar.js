  ...
  return (
    <div className="sidebar-page">
      ...
      <div className="main-content">
        ...
        <p>
          Explore the wide array of events happening in Nairobi. Whether you're interested in art, music, food, or festivals, 
          there's something for everyone. Get ready to discover and enjoy the unique experiences Nairobi has to offer.
        </p>
      </div>
    </div>
  );
